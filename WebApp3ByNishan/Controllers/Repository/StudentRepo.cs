...
using WebApp3ByNishan.Models;

namespace WebApp3ByNishan.Controllers.Repository
{
    public class StudentRepo
    {
        ...
        public List<Student> GetAllRecord()
        {
            ...
            try
            {
                ...
                string conStr = @"server=DESKTOP-074S0JT\SQLEXPRESS; database=NishanDB; Trusted_Connection=True; TrustServerCertificate=True;";
